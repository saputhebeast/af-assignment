...
import { addBookingSchema, reviewBookingSchema } from "../../schema/booking.schema";
import { addBooking, deleteBooking, getBooking, getBookings, updateBookingStatus } from "../../service/booking.service";
...
booking.post(
  ...
  tracedAsyncHandler(async function addBookingController(req, res) {
    const timetable = await traced(addBooking)(req.body);
